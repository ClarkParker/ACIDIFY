...
| Zone | What it is |
|---|---|
| Top left | Logo, TIPS / DARK / POWER buttons |
...
| **CHARACTER** | **PURE** – subtle level-dependent saturation. **MACKIE** – modeled mixer-preamp crunch. **PHONO** – the 90s trick: a 303 plugged into the phono input of a home amplifier, RIAA curve and all. From warm to fully blown out. |
