...
> Status: **DSP+UI 2.18.0 — Silver Series, eingebaute Panel-Tour („?“ neben dem Logo)**. Clean-Core,
...
> grundsätzlich passend bestätigt; der neue 2.18.0-Build muss für die
...
- `docs/manual/ACIDIFY_Manual.pdf` – druckfertiges A4-Handbuch (Build: `tools/build_manual_pdf.mjs`)
